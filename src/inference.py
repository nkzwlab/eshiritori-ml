...
if __name__ == '__main__':
    ...
    net.load_state_dict(torch.load("./weights/RN18_ver1_|_1000_per_class_|_3_epochs_best.pth"))
    print("done.")
    ...
    plot_image_tensor(image_tensor.squeeze(0),"./src/shusuke.png")
    ...
    values, indices = infer(net, image_tensor.unsqueeze(0), top_n=5)
    print("done.")
